package com.example.instagramprofilecard.presentation
...
class MainViewModel : ViewModel() {
    ...
    fun changeFollowingStatus(model: InstagramModel) {
        val modifierList = _models.value?.toMutableList() ?: mutableListOf()
        modifierList.replaceAll {
            if(it == model) {
